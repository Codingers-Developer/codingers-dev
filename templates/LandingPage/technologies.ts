...
export const technologies: Technology[] = [
  ...
  },
  {
    ...
    description:
      "Hi, Nama saya adalah Ahmad nur sahid bisa di panggil Ahmad, lahir di Garut pada tanggal 05 Agustus. Saya adalah anak ke-2 dari 3 bersaudara. Sejak kecil, saya sudah tertarik dengan teknologi dan komputer, dan itu menjadi alasan utama saya memilih jurusan Teknik Informatika di ITG (Institut Teknologi Garut). Saat ini, saya sedang menempuh semester 3 dan masih terus belajar mengenai berbagai aspek teknologi informasi seperti pemrograman, Algoritma, dan pengolahan data. Walaupun kadang-kadang terasa sulit, namun saya merasa sangat tertantang dan semangat untuk terus belajar dan meningkatkan kemampuan saya di bidang ini.",
    links: [
      {
        title: "Instagram",
